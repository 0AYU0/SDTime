...
@Component({
  ...
  styleUrls: ['./enrollment-chart.component.less']
})
export class EnrollmentChartComponent implements OnInit {
  ...
  private svg: any;
  private margin = 48;
  private width = 960 - (this.margin * 2);
  ...
  private createSvg(): void {
    this.svg = d3.select("figure#enrollment")
    .append("svg")
  ...
  private drawBars(data: any[]): void {
    ...
    .enter()
    .append("rect")
    .attr("x", (d: { Framework: string; }) => {
      return x(d.Framework);
    })
